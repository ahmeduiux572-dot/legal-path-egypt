...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "مُحامٍ | منصة قانونية رقمية" },
      {
        name: "description",
        content:
          "مُحامٍ منصة قانونية رقمية تربط العملاء بأفضل المحامين في مصر والشرق الأوسط: استشارات، حجز، سوق قضايا ونماذج قانونية.",
      },
      { name: "author", content: "مُحامٍ" },
      ...
      { name: "twitter:title", content: "مُحامٍ | منصة قانونية رقمية" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Amiri:wght@400;700&family=Tajawal:wght@400;500;700;800&family=Cairo:wght@400;600;700;800&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
